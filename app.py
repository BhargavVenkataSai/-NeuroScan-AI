...
api_key = "AIzaSyCJfp7tH47UVrJR3qwnFYl6TWYzx9_xYWU"  # Replace with your actual API key
...
def create_pdf_report(pdf_filepath, image_filename, processed_image_path, detections, gemini_response):
    ...
    c.drawString(100, height - 100, f"Processed Image: {processed_image_path}")
...
if __name__ == '__main__':
>>>>>>> 73fe07f8100795e5aab09dae4c77b1d7da78f58f
    app.run(debug=True)